...
// Validate checks the field values on UFO with the rules defined in the proto
// definition for this message. If any rules are violated, the first error
// encountered is returned, or nil if there are no violations.
func (m *UFO) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UFO with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in UFOMultiError, or nil if none found.
func (m *UFO) ValidateAll() error {
	return m.validate(true)
}

func (m *UFO) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UFOMultiError(errors)
	}

	return nil
}

// UFOMultiError is an error wrapping multiple validation errors returned by
// UFO.ValidateAll() if the designated constraints aren't met.
type UFOMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UFOMultiError) Error() string {
...
func (m UFOMultiError) AllErrors() []error { return m }

// UFOValidationError is the validation error returned by UFO.Validate if the
// designated constraints aren't met.
type UFOValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e UFOValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UFOValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UFOValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UFOValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UFOValidationError) ErrorName() string { return "UFOValidationError" }

// Error satisfies the builtin error interface
func (e UFOValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = UFOValidationError{}
...
func (m *CreateResponse) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetUfo()).(type) {
	...
	} else if v, ok := interface{}(m.GetUfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
